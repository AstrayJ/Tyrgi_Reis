    ...
    return (
        <>
            <div>
                ...
                <div className="riba">
                    <button className="nupp"> <a onClick={()=>window.location.href = route("meist")}> Meist</a></button>
                    <button className="nupp"> <a onClick={()=>window.location.href = route("ajakava")}> Ajakava</a></button>

...
export default function Ajakava() {

    return (
        <>
            <div>
                <h6 className="pealkiri">Ajakava</h6>
                <div style={{paddingRight: "20%", paddingLeft: "-20px",paddingTop: "10%"}}>
                    <div id="tegelane1" className="kastid2">
                        <div>
                        
                        <h3 style={{fontSize: "48px", lineHeight: "1.16", whiteSpace: "pre-wrap"}}>Siia tuleb kunagi ajakava, trust me</h3>
                        </div>
                        <div style={{marginLeft: "15%"}}>
                            <img src="https://t4.ftcdn.net/jpg/00/89/02/67/360_F_89026793_eyw5a7WCQE0y1RHsizu41uhj7YStgvAA.jpg"></img>
                        </div>
